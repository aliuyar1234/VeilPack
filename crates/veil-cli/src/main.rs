...
fn main() -> ExitCode {
    ...
    match args[0].as_str() {
        ...
        "extract-worker" => cmd_extract_worker(&args[1..]),
        _ => {
            log_error(
                LogContext::unknown(),
                "cli_unknown_command",
...
fn cmd_extract_worker(args: &[String]) -> ExitCode {
...
fn is_risky_extractor_type(artifact_type: &str) -> bool {
    matches!(
        artifact_type,
